  ...
  return (
    <section className="relative overflow-hidden bg-vgu-red-dark py-20 md:py-14">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <div className="absolute -right-[5%] -top-[30%] h-[400px] w-[400px] rounded-full bg-[radial-gradient(circle,rgba(255,164,18,0.2)_0%,transparent_70%)] blur-[80px]" />
        <div className="absolute -bottom-[20%] -left-[5%] h-[400px] w-[400px] rounded-full bg-[radial-gradient(circle,rgba(192,64,54,0.4)_0%,transparent_70%)] blur-[80px]" />
      </div>

      <div className="relative z-10 mx-auto max-w-[720px] px-12 text-center md:px-5">
        ...
        <p className="mt-5 text-[18px] text-white/75 leading-relaxed max-w-[480px] mx-auto">
