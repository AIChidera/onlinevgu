const ITEMS = [
  {
    ...
    bg: 'linear-gradient(135deg,#C04036,#821a12)',
  },
  {
    abbr: 'A+',
    abbrSize: '20px',
    name: 'NAAC A+',
    sub: 'Accredited University',
    bg: 'linear-gradient(135deg,#FFA412,#e08800)',
  },
  {
    abbr: 'AICTE',
    abbrSize: '12px',
    name: 'AICTE Approved',
    sub: 'Technical Programs',
    bg: 'linear-gradient(135deg,#1e3a5f,#0f1e33)',
  },
  {
    abbr: 'QS',
    abbrSize: '18px',
    name: 'QS Asia Ranked',
    sub: 'World University Rankings',
  ...
  },
  {
    ...
    sub: '7,000+ courses included',
    bg: 'linear-gradient(135deg,#0056D2,#003a8c)',
  },
]
      ...
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="grid grid-cols-2 gap-3 lg:flex lg:items-stretch lg:divide-x lg:divide-neutral-200 lg:gap-0">
          {ITEMS.map((item, i) => (
            ...
            >
              <div
                className="w-10 h-10 lg:w-11 lg:h-11 rounded-xl flex items-center justify-center flex-none shadow-sm transition-transform duration-200 group-hover:scale-110"
                style={{ background: item.bg }}
              >
                <span
                  className="font-heading font-black text-white leading-none text-center"
                  style={{ fontSize: item.abbrSize }}
                >
                  {item.abbr}
                </span>
              </div>
