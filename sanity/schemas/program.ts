...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'slug',
      group: 'basics',
      description: 'URL path for this program (e.g. "mba" → /programs/mba). Set once and do not change.',
    ...
    defineField({
      ...
      type: 'string',
      group: 'fees',
      description: 'Shown in program chips. E.g. "₹85,000/yr".',
      validation: R => R.required(),
    }),
    defineField({
      name: 'totalFee',
    ...
    defineField({
      ...
      type: 'string',
      group: 'fees',
      description: 'Leave blank if no EMI is available. E.g. "₹7,084/month".',
    }),
    defineField({
      name: 'nextBatch',
    ...
    defineField({
      ...
      type: 'string',
      group: 'careers',
      description: 'E.g. "₹10-18 LPA". Leave blank if unknown.',
    }),
    defineField({
      name: 'topHirers',
    ...
    defineField({
      ...
      description: 'Shown behind the dark-red gradient in the hero. 1400×900px recommended.',
    }),
  ],
